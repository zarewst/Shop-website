    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='', max_length=300, verbose_name='Имя пользователя')),
                ('last_name', models.CharField(default='', max_length=300, verbose_name='Фамилия пользователя')),
